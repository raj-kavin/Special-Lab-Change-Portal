    ...
    <div id="wrapper" style="background-color: var(--primary);">
        ...
        <ul class="navbar-nav  sidebar sidebar-dark accordion"  id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                <div class="sidebar-brand-text mx-3" style="font-weight:900">BIT Camps</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/view-home-page">
                    ...
                    <span style="font-weight:900;">Home</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/handle-logout">
                    <i class="fas fa-fw fa-power-off" ></i>
                    <span style="font-weight:900;">Logout</span></a>
            </li>
            ...
            <div class="text-center d-none d-md-inline">
                <button style="font-weight:900;" class="rounded-circle border-0 " id="sidebarToggle"></button>
            </div>
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>
                            &copy; Copyright <b><i>Alpha</i></b> | All rights reserved | Co-created by <a style="color:#56509f; font-weight:bold;" href="https://www.bitsathy.ac.in/" target="_blank">BIT Team</a>
                        </span>
                    </div>
                </div>
            </footer>
