...
@section('dashboard-admin-content')
    ...
    <div class="card" style="background-color:rgb(187,187,233);border-radius: 30px;">
        <div class="card-body">
            ...
            <h3 class="panel-title" style="text-align:center;color:#010101;font-weight:900">Register Students</h3>
            <br>
            ...
            <form action="/insert-staff-data" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label for="staff_id" style="color:#030303;font-weight:900">Roll No.</label>
                        <input type="text" class="form-control" id="staff_id" name="staff_id"
                            placeholder="Enter Roll No." autocomplete="off" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="first_name" style="color:#070707;font-weight:900">First Name</label>
                        <input type="text" class="form-control" id="first_name" name="first_name"
                            placeholder="Enter First Name" autocomplete="off" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="last_name" style="color:#080808;font-weight:900">Last Name</label>
                        <input type="text" class="form-control" id="last_name" name="last_name"
                            placeholder="Enter Last Name" autocomplete="off" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="date_of_birth" style="color:#060606;font-weight:900">Date of Birth</label>
                        <input type="date" class="form-control" id="date_of_birth" name="date_of_birth"
                            autocomplete="off" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="email" style="color:#090909;font-weight:900">BIT Sathy mail</label>
                        <input type="email" class="form-control" id="email" name="email"
                            placeholder="Enter Email Address" autocomplete="off" required>
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="phone_number" style="color:#060606;font-weight:900">Phone Number</label>
    ...
    <div class="card" style="background-color:rgb(187,187,233);border-radius: 30px;">
        <div class="card-body" style="overflow: scroll">
            ...
            <form action="/import-data" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="file" name="xlupload" style="color:#090909;font-weight:900;border:none">
